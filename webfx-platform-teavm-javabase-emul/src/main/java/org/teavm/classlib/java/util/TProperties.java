 ...
 * @since   1.0
 */
public class TProperties extends THashMap<Object,Object> {
    /**
...
*/
     ...
     * @serial
     */
    protected volatile TProperties defaults;
     ...
     * as in Hashtable.
     */
    private transient volatile TConcurrentHashMap<Object, Object> map;
     ...
     *         zero.
     */
    public TProperties(int initialCapacity) {
     ...
     */
    public TProperties(TProperties defaults) {
        this(defaults, 8);
    }

    private TProperties(TProperties defaults, int initialCapacity) {
        // use package-private constructor to
        // initialize unused fields with dummy values
        super(/*(Void) null*/);
        map = new TConcurrentHashMap<>(initialCapacity);
    ...
    public synchronized void load(TReader reader) throws TIOException {
        TObjects.requireNonNull(reader, "reader parameter is null");
     ...
     * @since 1.2
     */
    public synchronized void load(TInputStream inStream) throws TIOException {
        TObjects.requireNonNull(inStream, "inStream parameter is null");
        load0(new LineReader(inStream));
    }

    private void load0(LineReader lr) throws TIOException {
    ...
    private static class LineReader {
        LineReader(TInputStream inStream) {
            this.inStream = inStream;
            inByteBuf = new byte[8192];
        }

        LineReader(TReader reader) {
            this.reader = reader;
        ...
        private int inOff = 0;
        private TInputStream inStream;
        private TReader reader;

        int readLine() throws TIOException {
            try {
                return readLine0();
        ...
        private int readLine0() throws java.io.IOException {
                    ...
                    if (c == '#' || c == '!') {
                        ...
                        commentLoop: while (true) {
                            if (fromStream) {
                                ...
                                if (off == limit) {
                                    inLimit = limit = reader.read(charBuf, 0, charBuf.length);
                                    if (limit <= 0) { // EOF
                                        return -1;
                                    }
                                    off = 0;
...
*/
    ...
    public TSet<String> stringPropertyNames() {
        TMap<String, String> h = new THashMap<>();
        enumerateStringProperties(h);
        return h.keySet(); //Collections.unmodifiableSet(h.keySet());
    }
    ...
    public void list(TPrintStream out) {
        ...
        TMap<String, Object> h = new THashMap<>();
        enumerate(h);
        TIterator<TMap.Entry<String, Object>> it = h.entrySet().iterator();
        while (it.hasNext()) {
            TMap.Entry<String, Object> e = it.next();
            String key = e.getKey();
            String val = (String)e.getValue();
            if (val.length() > 40) {
...
*/
     ...
     */
    private void enumerate(TMap<String, Object> h) {
        if (defaults != null) {
            defaults.enumerate(h);
        }
        TIterator<TMap.Entry<Object, Object>> it = entrySet().iterator();
        while (it.hasNext()) {
            TMap.Entry<Object, Object> e = it.next();
            String key = (String)e.getKey();
     ...
     * @param h the Map
     */
    private void enumerateStringProperties(TMap<String, String> h) {
        if (defaults != null) {
...
*/
    ...
    @Override
    public synchronized void putAll(TMap<?, ?> t) {
        map.putAll(t);
    }
    ...
    public TSet<Object> keySet() {
        return map.keySet() ;// Collections.synchronizedSet(map.keySet(), this);
    }

    @Override
    public TCollection<Object> values() {
        return map.values();// Collections.synchronizedCollection(map.values(), this);
    }

    @Override
    public TSet<TMap.Entry<Object, Object>> entrySet() {
        return new EntrySet(map.entrySet()); //Collections.synchronizedSet(new EntrySet(map.entrySet()), this);
    }
     ...
     */
    private static class EntrySet implements TSet<TMap.Entry<Object, Object>> {
        private TSet<TMap.Entry<Object,Object>> entrySet;

        private EntrySet(TSet<TMap.Entry<Object, Object>> entrySet) {
        ...
        @Override
        public boolean add(TMap.Entry<Object, Object> e) {
            throw new UnsupportedOperationException();
        }

        @Override
        public boolean addAll(TCollection<? extends TMap.Entry<Object, Object>> c) {
            throw new UnsupportedOperationException();
        }
        ...
        @Override
        public TIterator<TMap.Entry<Object, Object>> iterator() {
    ...
    /*@Override
    public synchronized void forEach(TBiConsumer<? super Object, ? super Object> action) {
        map.forEach(action);
    }*/

    /*@Override
    public synchronized void replaceAll(TBiFunction<? super Object, ? super Object, ?> function) {
    ...
    public synchronized Object computeIfAbsent(Object key,
                                               TFunction<? super Object, ?> mappingFunction) {
        return map.computeIfAbsent(key, mappingFunction);
    }*/

    /*@Override
    public synchronized Object computeIfPresent(Object key,
                                                TBiFunction<? super Object, ? super Object, ?> remappingFunction) {
