    ...
    public static void registerPwa() { // Called by Gwt/J2ClEntryPoint (generated by WebFX) on GWT/J2CL application startup
        ...
        if (serviceWorker == null) {
            ...
            if (!pwa) {
                ...
                DomGlobal.window.addEventListener("beforeinstallprompt", GwtJ2clUtil::setPwaBeforeInstallPromptEvent);
                DomGlobal.window.addEventListener("appinstalled", GwtJ2clUtil::setPwaAppInstalledEvent);
            }
        }
    }
