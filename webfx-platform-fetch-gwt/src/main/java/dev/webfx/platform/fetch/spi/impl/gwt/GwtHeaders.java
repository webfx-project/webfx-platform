 ...
 * @author Bruno Salmon
 */
final class GwtHeaders implements Headers {
    ...
    public GwtHeaders(elemental2.dom.Headers jsHeaders) {
    ...
    public Iterator<String> keys() {
        return GwtUtil.jsIteratorToJavaIterator(jsHeaders.keys());
    }

    @Override
    public Iterator<String> values() {
        return GwtUtil.jsIteratorToJavaIterator(jsHeaders.values());
    }
}
