package dev.webfx.platform.storage.spi.impl.jre;
 ...
 * @author Bruno Salmon
 */
public final class JreLocalStorageProvider extends JreStorageProvider implements LocalStorageProvider {
    ...
    public JreLocalStorageProvider() {
        loadProperties();
