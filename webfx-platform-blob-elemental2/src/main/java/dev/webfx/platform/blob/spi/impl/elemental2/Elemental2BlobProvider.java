 ...
 * @author Bruno Salmon
 */
public final class Elemental2BlobProvider implements BlobProvider {

    @Override
    public Blob createBlob(Object platformBlob) {
        return new Elemental2Blob((elemental2.dom.Blob) platformBlob);
    }
    ...
    public Blob createTextBlob(String text) {
        ...
        return new Elemental2Blob(new elemental2.dom.Blob(parts, bag));
    }
