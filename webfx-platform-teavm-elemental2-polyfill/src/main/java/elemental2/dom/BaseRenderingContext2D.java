...
public class BaseRenderingContext2D implements CanvasDrawingStyles, CanvasPathMethods {
    ...
    public interface CanvasUnionType extends JSObject {
    ...
    */
    public interface CreatePatternImageUnionType extends JSObject {
        static BaseRenderingContext2D.CreatePatternImageUnionType of(Object o) {
            return Js.cast(o);
        }
    }

    public interface DrawImageImageUnionType extends JSObject {
    ...
    public interface FillStyleUnionType extends JSObject {
    ...
    */
    public interface StrokeStyleUnionType extends JSObject {
    ...
    //@JsOverlay
    public native void fill(Path2D optFillRuleOrPath, String optFillRule);/* {
        fill(
    ...
    @JsOverlay*/
    public native void fill(Path2D optFillRuleOrPath);/* {
        fill(
            Js.<BaseRenderingContext2D.FillOptFillRuleOrPathUnionType>uncheckedCast(optFillRuleOrPath));
    }
...
*/
    ...
    public native void setTransform(DOMMatrixReadOnly m11OrMatrix);
